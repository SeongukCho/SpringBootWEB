...
// 스프링 프레임워크는 기본적으로 logback을 채택해서 로그 처리함
@Slf4j
...
public class NoticeController {
    ...
    /*
     * 게시판 리스트 보여주기
     * GetMapping(value = "notice/noticeList") => GET방식을 통해 접속되는
     * URL이 notice/noticeList 경우 아래 함수 ..
     * */
    ...
    public String noticeInsert(HttpServletRequest request, ModelMap model, HttpSession session) {
        ...
        try {
            // 로그인된 사용자 아이디를 가져오기
            // 로그일을 아직 구현하지 않았기에 공지사항 리스트에서 로그인 한 것처럼 Session값을 저장함
             ...
             * ########################################################################
             */
            log.info("ssesion_user_id : " + user_id);
